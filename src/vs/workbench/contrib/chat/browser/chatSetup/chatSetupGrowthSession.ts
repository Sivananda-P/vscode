...
export class GrowthSessionController extends Disposable implements IChatSessionItemController {
	...
	get items(): readonly IChatSessionItem[] {
		...
		return [{
			...
			label: localize('growthSession.label', "Try CogniAI"),
			description: localize('growthSession.description', "CogniAI is available. Try it for free."),
