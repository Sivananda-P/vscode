...
function createUnavailableModelItem(
	...
	if (reason === 'upgrade') {
		...
		hoverContent.appendMarkdown(localize('chat.modelPicker.upgradeHover', "[Upgrade to CogniAI Pro](command:workbench.action.chat.upgradePlan \" \") with a free 30-day trial to use the best models."));
	} else if (reason === 'update') {
