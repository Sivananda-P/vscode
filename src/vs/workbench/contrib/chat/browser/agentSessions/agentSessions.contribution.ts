...
import { CogniAISessionsController } from './cogniaiSessionsController.js';
...
registerWorkbenchContribution2(CogniAISessionsController.ID, CogniAISessionsController, WorkbenchPhase.AfterRestored);
